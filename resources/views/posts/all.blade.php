        ...
        <div class="">
            ...
            <div class="card my-4">
                <div class="card-header text-center">
                    <h3 class="py-2">
                        <i class="fas fa-list"></i> [教育處] 全數公告
                        @if($want)
                            搜尋「{{ $want }}」
                        @endif
                    </h3>
                ...
                <div class="card-body">
                    <table class="table rwd-table" style="word-break: break-all;">
                        ...
                        <tr>
                            ...
                            <th nowrap>
                                <form id="select_category_form" action='{{ route('posts.select_category') }}' method='post'>
                                @csrf
                                <select name="category" id="category">
                                    <option value="0">類別</option>
                                    <option value="5">行政公告</option>
                                    <option value="1">一般公告</option>
                                    <option value="2">競賽訊息</option>
                                    <option value="3">活動成果</option>
                                    <option value="4">新聞快訊</option>
                                </select>
                                </form>
                            </th>
                            <th nowrap>
                            ...
                            <th nowrap>
                                <form id="select_situation_form" action='{{ route('posts.select_situation') }}' method='post'>
                                    @csrf
                                    <select name="situation" id="situation">
                                        <option value="a">狀態</option>
                                        <option value="0">退回</option>
                                        <option value="1">審核中</option>
                                        <option value="2">已讀未審</option>
                        ...
                        @foreach($posts as $post)
                            <tr>
                                ...
                                <td data-th="發佈人">
                                    <a href="{{ route('posts.all_user_id',$post->user_id) }}" class="text-primary">
