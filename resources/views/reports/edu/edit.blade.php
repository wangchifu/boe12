        ...
        <div class="">
            ...
            <div class="card my-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('edu_report.update',$report->id) }}" method="post" enctype="multipart/form-data" id="this_form" onsubmit="change_button()">
                        @csrf
                        @method('patch')
                    ...
                    <div class="form-group">
                        ...
                        <input id="die_date" name="die_date" required maxlength="10" placeholder="十碼：2019-01-01" class="form-control" value="{{ $report->die_date }}" width="250">
                        ...
                        <div id='show_question'>
                            ...
                            <div style="border-style:dashed;padding: 10px;margin: 15px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type[{{ $q }}]" id="type1" class="form-control" onchange="show_type(this, {{ $q }});" required>
                                        <option value="" disabled {{ is_null($question->type) ? 'selected' : '' }}>選擇題型</option>
