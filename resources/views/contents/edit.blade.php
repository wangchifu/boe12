            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" class="form-control" required placeholder="標題" value="{{ old('title', $content->title) }}">
                    </div>
                    <div class="form-group">
                        <label for="content">內文*</label>
                        <textarea name="content" id="my-editor" class="form-control" required>{{ old('content', $content->content) }}</textarea>
                    </div>
