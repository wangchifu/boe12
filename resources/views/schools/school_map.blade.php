@extends('layouts.app') @section('title','內容管理 | ') @section('content') 
<!--
<script src="https://github.com/makeusabrew/bootbox/releases/download/v6.0.0/bootbox.min.js"></script>
-->
<!-- icons -->
<link rel="stylesheet" href="./chcschool/fontawesome-all.css">
<link rel="stylesheet" href="./chcschool/animate.min.css">
<link rel="stylesheet" href="./chcschool/bootstrap.min.css">
<link rel="stylesheet" href="./chcschool/style.css">
<style>
  .contRelative {
    position: relative;
  }
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-round-lg btn-light" data-dismiss="modal">關閉</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="modal fade" id="defaultModal511" role="dialog" aria-labelledby="defaultModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-info btn-round-lg btn-default" data-dismiss="modal" onclick="javascript:location.href=&#39;https://visit.chc.edu.tw/search/511/township&#39;">探索本鄉</button>
                      <button type="button" class="btn btn-round-lg btn-light" data-dismiss="modal">關閉</button>
                    </div>
                  </div>
                </div>
              ...
              <div class="modal fade" id="defaultModal521" role="dialog" aria-labelledby="defaultModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-info btn-round-lg btn-default" data-dismiss="modal" onclick="javascript:location.href=&#39;https://visit.chc.edu.tw/search/521/township&#39;">探索本鎮</button>
                      <button type="button" class="btn btn-round-lg btn-light" data-dismiss="modal">關閉</button>
                    </div>
                  </div>
                </div>
              ...
              <div class="modal fade" id="defaultModal522" role="dialog" aria-labelledby="defaultModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-info btn-round-lg btn-default" data-dismiss="modal" onclick="javascript:location.href=&#39;https://visit.chc.edu.tw/search/522/township&#39;">探索本鄉</button>
                      <button type="button" class="btn btn-round-lg btn-light" data-dismiss="modal">關閉</button>
                    </div>
                  </div>
                </div>
