                            ...
                            @foreach($post5 as $post)
                                <tr>
                                    ...
                                    @if($post->signed_at==null and $post->situation != 4)
                                        {{ Form::open(['route'=>['posts.signed',$post->ps_id],'method'=>'patch','id'=>'sign_check_form'.$post->id]) }}
                                        @csrf
                                    ...
                                    <td data-th="列印">
                                        <a href="{{ route('posts.showSigned_print',$post->id) }}" class="btn btn-outline-secondary btn-sm" target="_blank"><i class="fas fa-print"></i> <i class="fas fa-sort-amount-up"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
