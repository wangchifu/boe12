    ...
    <div class="py-5">
        <div class="">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('introductions.admin_organization',$section_id) }}">業務簡介</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('introductions.admin_people',$section_id) }}">科室成員</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('introductions.admin_site',$section_id) }}">資源網站</a>
                </li>
            </ul>
            <br>
            <form action="{{ route('introductions.admin_store') }}" method="post">
                ...
                <div class="form-group">
                    <textarea id="mytextarea" name="content" class="form-control" required>{{ old('content', $content) }}</textarea>
                </div>                                
