        ...
        <div class="">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">新增宣導網站</li>
                </ol>
            </nav>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('links.store') }}" method="POST" id="this_form" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class="form-group">
                        <label for="image">圖片*(600x200)</label><br>
